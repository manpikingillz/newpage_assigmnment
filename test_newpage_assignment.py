...
#             })
#     transformed_data.to_excel('intest.xlsx')
#     sites_data.transform_data().to_excel('from_method.xlsx')
#     assert_frame_equal(transformed_data.reset_index(drop=True), sites_data.transform_data().reset_index(drop=True))
#     # transformed_data.compare(sites_data.transform_data())
